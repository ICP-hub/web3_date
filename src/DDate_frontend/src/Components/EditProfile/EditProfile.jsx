...
//             <div>
//               <div className="absolute z-20 md:relative md:z-auto">
//                 {<SidebarComponent />}
//               </div>
//               <div className="font-viga justify-center md:flex block md:w-4/5 w-full float-right  md:ml-auto md:pl-4">

//                 <div className="md:w-3/4 w-full">

//                   <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white md:text-black text-center ">
//                     <div className="flex items-center">
//                       <svg className=" mt-10 flex-shrink-0 ml-5 cursor-pointer" width="20" height="12" viewBox="0 0 12 12  " fill="none" xmlns="http://www.w3.org/2000/svg">
...
//                   <div className="border-t-2 border-solid md:border-black border-white w-[90% ] mt-4 mb-4 md:ml-6 mx-auto"></div>
        ...
        <FormProvider {...methods}>
          <div className=" ">
            <div>
              ...
              <div className="font-viga justify-center md:flex block sm:w-4/5 w-full float-right">
