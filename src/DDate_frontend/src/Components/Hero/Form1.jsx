...
const Form1 = () => {
    ...
    return (
        <div className="w-full rounded-lg p-6 shadow-md md:bg-transparent md:shadow-none">
                ...
                <div className="flex flex-wrap gap-2 md:gap-2 -mb-1 py-2 px-0 rounded-3xl">
                    {["Male", "Female", " Non binary"].map((gender) => (
                        <label key={gender} className={`inline-block px-3 py-2 rounded-full text-sm focus:outline-none transition duration-300
                            ${selectedGender === gender ? 'bg-primary-option_color text-black' : 'bg-transparent hover:bg-primary-option_color hover:text-black text-black md:text-black border border-black'}`}>
                            <input
                                type="radio"
                                name="usergender"
                                value={gender}
            ...
            {/* Email Input */}
            <div className="mb-4">
                <label htmlFor="email" className="block text-lg font-semibold mb-2 text-black md:text-black">
                ...
                <input
                    ...
                    // {...register('email')}
                    className="form-input bg-transparent w-full border-2 text-sm px-2 border-gray-300 py-1.5 rounded-3xl text-black"
                />
            ...
            {/* Username Input */}
            <div className="mb-4">
                <label htmlFor="username" className="block text-lg font-semibold mb-2 text-black md:text-black">
                ...
                <input
                    ...
                    className="form-input bg-transparent w-full border-2 px-2 border-gray-300 py-1.5 rounded-3xl text-black md:text-black text-sm"
                />
            ...
            {/* Mobile Number Input */}
            <div className="mb-4">
                <label htmlFor="mobile" className="block text-lg font-semibold mb-2 text-black md:text-black">
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <PhoneInput
                            ...
                            className="text-sm bg-transparent  w-full border-2 px-2 border-gray-300 py-1.5 rounded-3xl text-black md:text-black"
                        />
                    )}
                />
                {/* <PhoneInput
                    ...
                    className="form-input text-sm bg-transparent w-full border-2 px-2 border-gray-300 py-1.5 rounded-3xl text-black md:text-black"
                /> */}
                {/* <input
                    id="mobile"
                    type="tel"
            ...
            {/* DOB Input */}
            <div className="mb-4">
                <label htmlFor="dob" className="block text-lg font-semibold mb-2 text-black md:text-black">
                    Enter Your DOB
                ...
                <input
                    ...
                    className="form-input bg-transparent text-sm w-full border-2 px-2 border-gray-300 py-1.5 rounded-3xl text-black md:text-black"
                />
